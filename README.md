# TFT Forecaster in NeuralForecast

TFT Forecaster for the Forecasting problem category as per Ready Tensor specifications.
...
- A **TFT Forecaster** algorithm built using **NeuralForecast**
